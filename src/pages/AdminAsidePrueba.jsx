...
import { FaTimes } from "react-icons/fa"; // Importación del ícono para el botón de cierre
...
const AdminAsidePrueba = () => {
  ...
  const handleSubmitUser = (e) => {
    e.preventDefault();
    // Aquí iría la lógica para enviar los datos de usuario al backend
    setSuccessMessage("Usuario creado con éxito!");
    handleListItems(); // Vuelve a la lista
  };
